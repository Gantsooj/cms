...
<section class="content-header">
    <h1> Хуудас <small> | Хуудас засах</small> </h1>
    <ol class="breadcrumb">
        <li><a href="{!! url(getLang() . '/admin/page') !!}"><i class="fa fa-bookmark"></i> Хуудас</a></li>
        <li class="active">Хуудас засах</li>
    </ol>
</section>
<br>
<br>
<div class="container">
    ...
    <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            <label class="">{!! Form::checkbox('is_published', 'is_published',$page->is_published) !!} Нийтлэх ?</label>
