...
@section('content')
    ...
    <section class="content-header">
        <h1> Мэдээ <small> | Мэдээ засах</small> </h1>
        <ol class="breadcrumb">
    ...
    <div class="container">
        ...
        <div class="fileinput fileinput-new control-group {!! $errors->has('image') ? 'has-error' : '' !!}" data-provides="fileinput">
            ...
            <span class="btn btn-default btn-file"><span class="fileinput-new">Зураг сонгох</span><span class="fileinput-exists">Change</span>
                ...
                <button type="button" id="reset" class='btn btn-default'>Арилгах</button>
