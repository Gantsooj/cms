...
<div class="col-lg-10">
    ...
    <ul class="nav nav-tabs" id="myTab">
        <li class="active"><a href="#settings" data-toggle="tab">Тохиргоо</a></li>
        <li><a href="#info" data-toggle="tab">Тэмдлэглэл</a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="settings">
            <br>
            <h4><i class="glyphicon glyphicon-cog"></i> Тохиргоо</h4>
