...
<section class="content-header">
    <h1> Хэрэглэгч
        <small> | Хэрэглэгч нэмэх</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!! url(getLang(). '/admin/user') !!}"><i class="fa fa-user"></i> Хэрэглэгч</a></li>
...
<div class="container">
    ...
    <div class="control-group {!! $errors->has('first-name') ? 'has-error' : '' !!}">
        <label class="control-label" for="first-name">Нэр</label>
    ...
    <div class="control-group {!! $errors->has('last-name') ? 'has-error' : '' !!}">
        <label class="control-label" for="last-name">Овог</label>
    ...
    <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
        <label class="control-label" for="groups">Үүрэг</label>
        <div class="controls">
    ...
    <div class="control-group {!! $errors->has('confirm-password') ? 'has-error' : '' !!}">
        <label class="control-label" for="confirm-password">Давтан нууц үг</label>
