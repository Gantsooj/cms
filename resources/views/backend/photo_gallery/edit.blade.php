...
<section class="content-header">
    <h1> Зургийн цомог <small> | Засах</small> </h1>
    <ol class="breadcrumb">
        <li><a href="{!! url(getLang(). '/admin/photo-gallery') !!}"><i class="fa fa-desktop"></i> Зургийн цомог</a></li>
        <li class="active">Засах</li>
    </ol>
</section>
<br>
<br>
<div class="container">
    <!-- Dropzone -->
    <label class="control-label" for="title">Зураг</label>
            ...
            Dropzone.options.myDropzone = {
                init: function () {
                    this.on("addedfile", function (file) {
                        ...
                        var removeButton = Dropzone.createElement('<a class="dz-remove">Устгах</a>');
                        var _this = this;
    ...
    <div class="control-group {!! $errors->has('is_published') ? 'has-error' : '' !!}">
        ...
        <div class="controls">
            <label class="">{!! Form::checkbox('is_published', 'is_published',$photo_gallery->is_published) !!} Нийтлэх ?</label>
    ...
    <br>
    <!-- Form actions -->
    {!! Form::submit('Шинэчлэх', array('class' => 'btn btn-success')) !!}
    {!! Form::close() !!}
    <script type="text/javascript">
